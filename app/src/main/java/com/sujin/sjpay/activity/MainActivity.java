...
public class MainActivity extends BaseActivity implements TabLayoutView.OnTabLayoutClickListener{
    ...
    protected void initView() {
        ...
        tabData.add(new TabData(AppConstants.TAB_TAG_HOME, AppConstants.TAB_NAME_HOME, R.drawable.icon_home_unselect, R.drawable.icon_home_select));
        tabData.add(new TabData(AppConstants.TAB_TAG_PAY, AppConstants.TAB_NAME_PAY, R.drawable.icon_invest_unselect, R.drawable.icon_invest_select));
        tabData.add(new TabData(AppConstants.TAB_TAG_MY, AppConstants.TAB_NAME_MY, R.drawable.icon_my_unselect, R.drawable.icon_my_select));
